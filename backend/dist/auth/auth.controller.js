...
const addAccessTokenToResponse_1 = require("../utils/addAccessTokenToResponse");
let AuthController = class AuthController {
    ...
    status(response, request) {
        return (0, addAccessTokenToResponse_1.addAccessTokenToResponse)(request, response, true);
    }
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_gards_1.JwtGuard),
